...
public class KonfigurasiKelas {
    // url web API berada
    public static final String URL_GET_ALL = "http://192.168.1.6/training/kelas/tr_datas_kelas.php";
    public static final String URL_GET_DETAIL = "http://192.168.1.6/training/kelas/tr_detail_kelas.php?id_kls=";
    public static final String URL_ADD = "http://192.168.1.6/training/kelas/tr_add_kelas.php";
    public static final String URL_UPDATE = "http://192.168.1.6/training/kelas/tr_update_kelas.php";
    public static final String URL_DELETE = "http://192.168.1.6/training/kelas/tr_delete_kelas.php?id_kls=";
    ...
    public static final String TAG_JSON_ID_INS_TEMP = "id_ins";
    public static final String TAG_JSON_ID_MAT = "nama_mat";
    public static final String TAG_JSON_ID_MAT_TEMP = "id_mat";
